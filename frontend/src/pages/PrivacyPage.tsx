...
const sections = [
  { title: "What stays on this device", body: "Unfinished answers exist only in the open page's temporary memory and disappear if you close or reload it. Free text is cleared as soon as the local recommendation is created and is never added to history. Up to 20 result summaries, your onboarding status, and these privacy choices are kept in local storage until you clear them, clear browser/app data, or uninstall the app." },
      ...
      <div style={{ padding: "24px 20px 0" }}>
        ...
        <section aria-labelledby="privacy-controls" style={{ marginBottom: "24px" }}>
          ...
          <div style={{ backgroundColor: "#ffffff", borderRadius: "20px", padding: "18px 20px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
            <p style={{ fontSize: "13px", color: "#717171", lineHeight: 1.6, marginBottom: "14px" }}>Clear local history, onboarding status, privacy preferences, and any legacy draft keys from this device. This does not delete server, email, backup, or provider records.</p>
