...
export default function FeatureUnavailablePage({ feature }: { feature: string }) {
  return (
    <div style={{ minHeight: "100%", padding: "40px 24px", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#fff8f7" }}>
      <div style={{ width: "100%", maxWidth: "360px", padding: "32px 24px", borderRadius: "24px", backgroundColor: "#ffffff", border: "1px solid #f0f0f0", boxShadow: "0 8px 32px rgba(0,0,0,0.06)", textAlign: "center" }}>
        <div aria-hidden="true" style={{ width: "56px", height: "56px", margin: "0 auto 18px", borderRadius: "18px", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#FFF0F0", color: CORAL_TEXT, fontSize: "24px" }}>↻</div>
        <p style={{ marginBottom: "8px", color: CORAL_TEXT, fontSize: "12px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" }}>{feature}</p>
