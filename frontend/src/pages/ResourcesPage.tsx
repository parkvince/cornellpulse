  ...
  return (
    <div style={{ paddingBottom: "24px" }}>
      ...
      <div style={{ padding: "16px 20px 0" }}>
        ...
        {loading && <div role="status" style={{ fontSize: "14px", color: "#717171", textAlign: "center", padding: "36px 0" }}>Loading verified resources…</div>}
          ...
          return (
            <article key={resource.id} style={{ borderRadius: "16px", padding: "18px", backgroundColor: "#ffffff", marginBottom: "10px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", border: resource.category === "Crisis" ? `1.5px solid ${CORAL}` : "1px solid #f0f0f0" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "6px" }}>
                ...
                <span style={{ fontSize: "10px", fontWeight: 600, color: availability === "open" ? "#008577" : "#717171", backgroundColor: availability === "open" ? "#e8f7f4" : "#f5f5f5", padding: "3px 8px", borderRadius: "6px", whiteSpace: "nowrap" }}>{availability === "open" ? "OPEN NOW" : availability === "closed" ? "CLOSED" : "CHECK HOURS"}</span>
              </div>
