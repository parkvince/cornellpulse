...
const resources = [
  ...
  { cat: "Cornell", name: "Cornell Health 24/7 phone consultation", phone: "607-255-5155", url: "https://health.cornell.edu/get-care/247-phone-consultation", desc: "Call any time to consult with a medical or mental health provider. This is not emergency dispatch.", loc: "Phone", hours: "24/7 phone consultation", tags: ["24/7"] },
  ...
  { cat: "Crisis", name: "988 Suicide & Crisis Lifeline", phone: "988", text: "988", textBody: "Hello, I need support.", url: "https://988lifeline.org", desc: "Call or text 988 to connect with a trained crisis counselor, 24/7. Call 911 for an immediate physical safety threat.", loc: "Call / Text", hours: "24/7", tags: ["crisis", "24/7"] },
  { cat: "Crisis", name: "Crisis Text Line", phone: null, text: "741741", textBody: "HOME", url: "https://www.crisistextline.org", desc: "Text HOME to 741741 to connect with a crisis counselor by text.", loc: "Text only", hours: "24/7", tags: ["crisis", "text"] },
  { cat: "Crisis", name: "Cornell Public Safety Communications Center", phone: "607-255-1111", url: "https://publicsafety.cornell.edu/resources", desc: "Campus emergency dispatch and public-safety response, including Cornell Police. For an immediate emergency, call 911.", loc: "Ithaca campus", hours: "24/7", tags: ["crisis", "on-campus"] },
  { cat: "Crisis", name: "Cayuga Medical Center Emergency Department", phone: "607-274-4411", url: "https://health.cornell.edu/get-care/emergencies-after-hours-care", desc: "A 24/7 hospital emergency department for medical and mental health emergencies.", loc: "101 Dates Drive, Ithaca", hours: "24/7", tags: ["crisis", "emergency"] },
        ...
        {filtered.map(r => (
          <div key={r.name} style={{ borderRadius: "16px", padding: "18px", backgroundColor: "#ffffff", marginBottom: "10px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", border: r.cat === "Crisis" ? `1.5px solid ${CORAL}` : "1px solid #f0f0f0" }}>
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              ...
              {r.text && (
                <a href={`sms:${r.text}?body=${encodeURIComponent(r.textBody || "")}`} onClick={() => track(r.name, "text")} style={{ display: "flex", alignItems: "center", gap: "6px", padding: "10px 16px", backgroundColor: "#FFF0F0", color: CORAL, borderRadius: "10px", fontSize: "13px", fontWeight: 700 }}>
                  Text {r.text}{r.textBody ? ` · ${r.textBody}` : ""}
                </a>
              )}
              {r.url && (
