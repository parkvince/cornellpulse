...
export default function StepText({ value, onChange, college, onCollegeChange, colleges, onSubmit, onBack, loading, error }: Props) {
  return (
    <div>
      ...
      <p style={{ fontSize: "14px", color: "#717171", marginBottom: "24px" }}>Optional. Used only in this page's memory to make a local recommendation. It is not saved in your draft or history, and it is never sent.</p>
