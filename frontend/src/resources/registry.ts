...
export const RESOURCE_REGISTRY: readonly ResourceRecord[] = [
  ...
  verifiedResource({
    id: "learning_strategies", officialName: "Learning Strategies Center", description: "Academic support including study-skills resources, supplemental courses, tutoring, and learning support programs.", category: "Cornell", eligibility: "Program eligibility varies; many services focus on Cornell undergraduate students.", cost: "Many listed resources and drop-in tutoring options are free; course or program rules vary.", phone: null, textAction: null, url: "https://lsc.cornell.edu", location: "Programs use multiple campus and online locations; the main office is temporarily on the third floor of the Computing and Communications Center", hours: "Varies by program and academic term", timezone: "America/New_York", accessInstructions: "Review the current program page and schedule before attending or enrolling.", officialSourceUrl: "https://lsc.cornell.edu", tags: ["academics", "learning"],
  }),
  verifiedResource({
