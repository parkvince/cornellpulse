...
5. For announced seasonal schedules/closures, add a dated override and create a deadline no later than the end/change date even if the normal cadence is longer.
